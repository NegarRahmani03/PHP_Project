...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">Negar Rhamani | SRMS-(Student Result Management System)</a>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            ...
            <div class="container"><p class="m-0 text-center text-white"> negar rahmani moghadam</p></div>
        </footer>
        <!-- Bootstrap core JS-->
